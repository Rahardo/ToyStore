				...
				<div class="product-details">
					...
					<div class="product-details-row1">
						<div class="product-details-row1-head">
							<h2><?php echo $d['productName']; ?></h2>
							<p><?php echo $d['productOverview']; ?></p>
						</div>
								...
								<ul id="etalage">
									<li>
										<a href="optionallink.html">
											<img class="etalage_thumb_image" src="<?php echo base_url()?><?php echo $d['productPic1']; ?>" />
											<img class="etalage_source_image" src="<?php echo base_url()?><?php echo $d['productPic1']; ?>" />
										</a>
									</li>
									<li>
										<img class="etalage_thumb_image" src="<?php echo base_url()?><?php echo $d['productPic2']; ?>" />
										<img class="etalage_source_image" src="<?php echo base_url()?><?php echo $d['productPic2']; ?>" />
									</li>
									<li>
										<img class="etalage_thumb_image" src="<?php echo base_url()?><?php echo $d['productPic3']; ?>" />
										<img class="etalage_source_image" src="<?php echo base_url()?><?php echo $d['productPic3']; ?>" />
									</li>
								</ul>
							</div>
						</div>
					...
					<div class="col-md-8 product-details-row1-col2">
						...
						<div class="product-price">
							<div class="product-price-left text-right">
								<span>Rp<?php echo $d['productCost']; ?></span>
								<h5>Rp<?php echo $d['productFixCost']; ?></h5>
							</div>
							<div class="product-price-right">
								<a href="#"><span> </span></a>
								<label> save <b><?php echo $d['productDisc']; ?>%</b></label>
							</div>
							<div class="clearfix"> </div>
						</div>
						<div class="product-price-details">
							<p class="text-right"><?php echo $d['productDetail']; ?> </p>
