	...
	<body>
		...
		<div class="container">
			...
			<!----content---->
							...
							<div class="col-md-6 product-filter-grid1-brands-col2">
									<div class="producst-cate-grids">
										<div class="col-md-4 producst-cate-grid text-center">
											<h2>WOMAN</h2>
											<img class="r-img text-center img-responsive" src="<?php echo base_url()?>assets/images/img-w.jpg" title="name">
											<span><img src="<?php echo base_url()?>assets/images/objs1.png" title="name"></span>
											<h4>TOTAL</h4>
										...
										<div class="col-md-4 producst-cate-grid text-center">
											<h2>MAN</h2>
											<img class="r-img text-center img-responsive" src="<?php echo base_url()?>assets/images/man-r-img.jpg" title="name">
											<span><img src="<?php echo base_url()?>assets/images/objs2.png" title="name"></span>
											<h4>TOTAL</h4>
											<label>357 PRODUCTS</label>
											<a class="r-list-w" href="#"><img src="<?php echo base_url()?>assets/images/list-icon.png" title="list"></a>
										</div>
										<div class="col-md-4 producst-cate-grid text-center">
											<h2>KIDS</h2>
											<img class="r-img text-center img-responsive" src="<?php echo base_url()?>assets/images/kid-r-img.jpg" title="name">
											<span><img src="<?php echo base_url()?>assets/images/objs3.png" title="name"></span>
											<h4>TOTAL</h4>
											<label>357 PRODUCTS</label>
											<a class="r-list-w" href="#"><img src="<?php echo base_url()?>assets/images/list-icon.png" title="list"></a>
										</div>
				...
				<?php if ($d['productCategory'] === "papan"){ ?>
				...
				<div class="special-products all-poroducts">
					...
					<div class="special-products-grids">
						<div class="col-md-3 special-products-grid text-center">
							...
							<a class="product-here" href="single-page.html"><img src="<?php echo base_url()?>assets/images/p1.jpg" title="product-name" /></a>
					...
					<div class="special-products-grids">
						...
						<div class="col-md-3 special-products-grid text-center">
							<a class="brand-name" href="single-page.html"><img src="<?php echo base_url()?>assets/images/b2.jpg" title="name" /></a>
							<a class="product-here" href="single-page.html"><img src="<?php echo base_url()?>assets/images/p2.jpg" title="product-name" /></a>
							<h4><a href="#">Line Link 67009</a></h4>
							<a class="product-btn" href="single-page.html"><span>109.90$</span><small>GET NOW</small><label> </label></a>
						</div>
						<div class="col-md-3 special-products-grid text-center">
							<a class="brand-name" href="single-page.html"><img src="<?php echo base_url()?>assets/images/b3.jpg" title="name" /></a>
							<a class="product-here" href="single-page.html"><img src="<?php echo base_url()?>assets/images/p3.jpg" title="product-name" /></a>
							<h4><a href="single-page.html">Minimus Zero </a></h4>
							<a class="product-btn" href="single-page.html"><span>109.90$</span><small>GET NOW</small><label> </label></a>
						</div>
						<div class="col-md-3 special-products-grid text-center">
							<a class="brand-name" href="single-page.html"><img src="<?php echo base_url()?>assets/images/b4.jpg" title="name" /></a>
							<a class="product-here" href="single-page.html"><img src="<?php echo base_url()?>assets/images/p4.jpg" title="product-name" /></a>
							<h4><a href="single-page.html"> Athletic Shoe </a></h4>
							<a class="product-btn" href="single-page.html"><span>109.90$</span><small>GET NOW</small><label> </label></a>
						</div>
						<div class="col-md-3 special-products-grid text-center">
							<a class="brand-name" href="single-page.html"><img src="<?php echo base_url()?>assets/images/b5.jpg" title="name" /></a>
							<a class="product-here" href="single-page.html"><img src="<?php echo base_url()?>assets/images/p2.jpg" title="product-name" /></a>
							<h4><a href="single-page.html">Veronique </a></h4>
							<a class="product-btn" href="single-page.html"><span>109.90$</span><small>GET NOW</small><label> </label></a>
						</div>
						<div class="col-md-3 special-products-grid text-center">
							<a class="brand-name" href="single-page.html"><img src="<?php echo base_url()?>assets/images/b6.jpg" title="name" /></a>
							<a class="product-here" href="single-page.html"><img src="<?php echo base_url()?>assets/images/p6.jpg" title="product-name" /></a>
							<h4><a href="single-page.html">Suede Boots </a></h4>
							<a class="product-btn" href="single-page.html"><span>109.90$</span><small>GET NOW</small><label> </label></a>
						</div>
						<div class="col-md-3 special-products-grid text-center">
							<a class="brand-name" href="single-page.html"><img src="<?php echo base_url()?>assets/images/b7.jpg" title="name" /></a>
							<a class="product-here" href="single-page.html"><img src="<?php echo base_url()?>assets/images/p7.jpg" title="product-name" /></a>
							<h4><a href="single-page.html">Barricade 6.0  </a></h4>
							<a class="product-btn" href="single-page.html"><span>109.90$</span><small>GET NOW</small><label> </label></a>
						</div>
						<div class="col-md-3 special-products-grid text-center">
							<a class="brand-name" href="single-page.html"><img src="<?php echo base_url()?>assets/images/b1.jpg" title="name" /></a>
							<a class="product-here" href="single-page.html"><img src="<?php echo base_url()?>assets/images/p8.jpg" title="product-name" /></a>
